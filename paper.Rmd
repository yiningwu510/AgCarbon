...
We estimate the impact of cover crops on SOC stocks by linking the Rapid Carbon Assessment (RaCA) data with Crop Data Layer (CDL) data. Due to the different inputs and management with different crops, which are hard to control, here we consider the aggregate effects of crop species on SOC. Figure 1 shows the distribution of crop types over the last two years. We can find corn-soybean rotation is the predominant cropping system in the U.S. <!-- I don't like the stacked bar figure. It makes it difficult to know how many of each type of observation exist. Could you do side by side bars? Also, you should quantify how much of the total is corn-soybean.-->


![Distribution of crop types last year across crop types this year](output/figures/lastyear.png)

Focusing on the impact of 3 cropping sequences - continuous corn, continuous soybean, and corn-soybean rotation, we find planting corn for at least two years in every three years significantly increases SOC stocks compared to always fallow in the soil as deep as 100 cm. Specifically, 1) compared to keeping cropland always fallow, monocropping of corn significantly increase the SOC stocks by 1.24 tons/ha, and growing corn for two years and soybean for one year significantly increase the SOC stocks by 1.15 tons/ha. 2) Compared to soybean monocropping, monocropping of corn significantly increases the SOC stocks by 1.15 tons/ha, and growing corn for two years and soybean for one year significantly increase the SOC stocks by 1.14 tons/ha. 3) Compared to growing corn for one year and soybean for two years in every three years, monocropping of corn significantly increases the SOC stocks by 1.12 Mg/ha, and growing corn for two years and soybean for one year significantly increase the SOC stocks by 1.14 tons/ha. Corn plays an important role in the cropping system in improving SOC stocks, which might be explained by high residues after harvest. 
...
We first randomly sampled 40,000 points within the CDL for Ohio to understand what crop types were grown on these points across the years from 2008 to 2021. This process was then repeated for Iowa and Illinois. As Figure 3 shows, most points saw a roughly equal split in the number of years corn and soybeans were planted. For example, in Ohio, 3x.x% of the points planted both corn and soybeans for 7 years. In Illinois and Iowa, the number were 4x.x% and 4x.x%, respectively. Among the three states though, farmers in Ohio tend to plant soybeans more often than corn, while farmers in Iowa and Illinois tend to  plant corn more often than soybeans.

![Crop planting years of corn-soybean cropping system from 2009-2021](output/figures/14yearsrotation.png)

Applying the results of SOC stocks from RaCA, we next estimate the potential increase of SOC stocks with different policies (Table 1). 1) Converting always fallow, always soybean, and corn for one year followed by soybeans for two years to monocropping of corn, we estimate that the total gain of SOC stocks in Ohio, Iowa, and Illinois are about 1600g, 3565g, and 3210g, respectively. 2) Converting all of them to growing corn for one year, followed by soybean for one year, and then corn for another year are estimated to increase the SOC stocks by 1622g, 3615g, and 3255g. 3) Converting all of them to growing soybean for one year followed by 2 years of corn is estimated to increase the SOC stocks by 1626g, 3649g, and 3279g. The third policy is estimated to have the highest gain in SOC stocks on the whole.  
